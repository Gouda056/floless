  ...
  export const faqs: FAQType[] = [
    {
      ...
      summary: "Floless is a platform designed for professional photographers to share wedding or event photos, videos, and reels with wedding and event guests. It offers various customization options to enhance the viewing experience for both photographers and guests.",
      expanded: true,
      id: 0,
    },
    {
    ...
    {
      num: "3",
      question: "	What customization options does Floless offer for photos, videos, and reels?",
      summary: 
    ...
    },
    {
      ...
      summary: "Yes, Floless offers AI-enabled face recognition. Guests can upload a selfie, and our system will automatically match their face with the event's photos, making it easy for them to find and download their pictures.",
      expanded: false,
      id: 4,
    },
    {
      num: "6",
      question: "Is Floless suitable for both weddings and other types of events? ",
      summary:
      "Yes, Floless offers AI-enabled face recognition. Guests can upload a selfie, and our system will automatically match their face with the event's photos, making it easy for them to find and download their pictures.",
      expanded: false,
      id: 5,
    ...
    {
      num: "10",
      question: "Can I collaborate with other photographers on Floless for the same event? ",
      summary:
